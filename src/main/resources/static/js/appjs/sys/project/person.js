        ...
        .bootstrapTable(
            {
                ...
                url : prefix + "/myproject/"+userId, // 服务器数据的加载地址
                showRefresh : true,
                // showToggle : true,
                showColumns : true,
                iconSize : 'outline',
                ...
                columns : [
                    ...
                    },
                    {
                        ...
                        formatter:function (value,row,index) {
                            return '<a href="#" onclick="preview(\''+ row.projectId+ '\')">'+row.projectName+'</a>';
                        }
                    },
                    {
                        visible : true,
...
function preview(projectId) {
    window.open("/blog/open/post/"+projectId);//在新窗口打开预览页面
...
function edit(projectId) {//
    var editPage = layer.open({
        ...
        shadeClose : false, // 点击遮罩关闭层
        area : [ '800px', '520px' ],
        content : prefix + '/edit/' + projectId // iframe的url
    });
    layer.full(editPage);
}
