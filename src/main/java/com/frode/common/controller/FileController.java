...
public class FileController extends BaseController {
	...
	public R remove(Long id, HttpServletRequest request) {
		...
		String fileName = schoolConfig.getUploadPath() + sysFileService.get(id).getUrl().replace("/files/", "");
	...
	R upload(@RequestParam("file") MultipartFile file, HttpServletRequest request) {
		...
		try {
			FileUtil.uploadFile(file.getBytes(), schoolConfig.getUploadPath(), fileName);
		} catch (Exception e) {
			return R.error();
		}
